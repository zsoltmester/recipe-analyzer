...
public class TestRecipes extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String DATA_PATH = userDirectory + "LabelledRecipes";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(TestRecipes.class.getName()).log(Level.SEVERE, null, ex);
